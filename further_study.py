...
def custom_append(input_list, value):
    ...
    """
    # input_list += [value] # Alternative soultion
...
def custom_remove(input_list, value):
    ...
    """
    1. Loop through list/notes
    2. Check elem against the value
        if it's equal, then remove value
    3. Break
    """

    for i in range(0, len(input_list)): 
        if input_list[i] == value: 
            input_list[i:i+1] = []  #you found the index! but should have a start and stop value
            break
